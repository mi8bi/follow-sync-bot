import os
from follow import follow_users, unfollow_users
from utils import get_followers, get_following
...
def main():
    ...
    follow_users(token, to_follow)
    unfollow_users(token, to_unfollow)
