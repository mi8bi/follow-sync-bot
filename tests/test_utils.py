...
class TestPagination:
    ...
    def test_paginate_single_page(self):
        ...
        responses.add(
            responses.GET, "https://api.github.com/test", json=mock_data, status=200
        )
    ...
    def test_paginate_empty_response(self):
        ...
        responses.add(responses.GET, "https://api.github.com/test", json=[], status=200)
...
class TestGetFollowers:
    ...
    def test_get_followers_empty(self):
        ...
        responses.add(
            responses.GET, "https://api.github.com/user/followers", json=[], status=200
        )
...
class TestGetFollowing:
    ...
    def test_get_following_empty(self):
        ...
        responses.add(
            responses.GET, "https://api.github.com/user/following", json=[], status=200
        )
